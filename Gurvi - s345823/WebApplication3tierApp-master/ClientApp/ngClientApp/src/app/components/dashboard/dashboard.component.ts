...
export class DashboardComponent implements OnInit {
  ...
  constructor(private rolesService : RolesService, private unitsService : UnitListService, private coursesService : CourseListService,
    private featuresService : FeaturesService, private reportsService : ReportListService, private greportsService : GReportListService) { }
  ...
  ngOnInit(): void {
    ...
    this.greportsService.getAllReports().subscribe({
      next : res => this.greports = res, 
      error : err => console.error(err)
    })
